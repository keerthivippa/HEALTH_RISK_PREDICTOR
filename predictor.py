    ...
    if st.session_state.current_prediction_type:
        ...
        with col2:
            if st.button("Analyze Health Metrics", key="analyze"):
                ...
                st.markdown("---")
                st.markdown("""
                    <div style='background-color: black; color: white; padding: 1rem; border-radius: 10px; 
        ...
        st.markdown("""
            <div class="metric-container">
                ...
                <ul>
                    ...
                    <li>❤ <strong>Heart Health Screening:</strong> Check cardiovascular health indicators</li>
                    <li>⚖ <strong>Weight Status Analysis:</strong> Analyze BMI and related health factors</li>
                </ul>
